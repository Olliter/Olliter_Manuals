...
The OL-Master software is licensed under the [GNU GPL v3](./SoftwareLicense.md). By installing or using the software, you agree to be bound by the terms of this license. If you do not agree to the terms of this license, do not install or use the software.
