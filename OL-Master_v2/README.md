...
# OL-Master v2 Software User Manual
...
1. [Introduction](#introduction)
    * [What's new in OL-Master v2](#whats-new-in-ol-master-v2)
...
As the OL-Master v2 software is no longer based on PowerSDR, the previous license (GPLv2) is no longer valid. The OL-Master v2 software is now distributed under the [Olliter Community License (OCL)](./SoftwareLicense.md).
...
### What's new in OL-Master v2

OL-Master v2 is a complete rewrite of the previous OL-Master v1.x software, with similar look and feel to the original version. It features:
